...
<tr valign="top">
<th scope="row"><label>Size for Posts</label></th>
...
<tr valign="top">
<th scope="row"><label>Use on pages</label></th>
<td>
<input type="checkbox" name="appStore_options[use_shortDesc_on_single]" value="yes" <?php if ($options['use_shortDesc_on_single'] == "yes") echo 'checked'; ?> /> with a Single Post<br />
<input type="checkbox" name="appStore_options[use_shortDesc_on_multiple]" value="yes" <?php if ($options['use_shortDesc_on_multiple'] == "yes") echo 'checked'; ?> /> with Multiple Posts<br />
<input type="checkbox" name="appStore_options[use_shortDesc_on_atomfeed]" value="yes" <?php if ($options['use_shortDesc_on_atomfeed'] == "yes") echo 'checked'; ?> /> with an ATOM Feed or List of Apps
</td>
</tr>
<tr valign="top">
