...
<input type="text" size="40" name="appStore_options[amazon_textlink_price_default]" value="<?php echo $options['amazon_textlink_price_default']; ?>"/> (<?php _e('product with price', 'appStoreAssistant' ); ?>)</td>
</tr>
</table>	
